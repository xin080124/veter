...
{
	class AnyRectangle : AnyShape
	{
		// constructor	
		public AnyRectangle(string shapeName, int x_at, int y_at, int shape_width, int shape_height, Color bkColor) 
		...
		public override void Display(Graphics g)
		{
			if (g != null)
			{
				...
				g.FillRectangle(br, x,y,shape_width,shape_height);
			}
