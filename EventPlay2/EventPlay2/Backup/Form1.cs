...
namespace EventPlay2
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		/// allow numbers, backspace, delete, enter and '.' 
		/// only in this textbox
		/// </summary>
		...
		/// When the form loads into memory change the color of 
		/// the form to light yellow and
		/// create a new NumberBox control
		/// finally make the KeyPress event of the new control
		/// point to the MyNumBox_KeyPress method
		/// </summary>
		...
		/// <summary> method: MyNumBox_KeyPress
		/// Although the NumberBox already has a built in event
		/// handler for the KeyPress event we can add
		/// another event handler for the same event
		/// this event handler copies the text in the
		/// NumberBox to a label when the Enter key is detected.
		/// </summary>
